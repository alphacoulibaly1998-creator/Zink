  ...
  fr: {
    translation: {
      ...
      inscription: {
        ...
        pseudoObligatoire: "Le pseudo est obligatoire.",
        mdpTropFaible: "Le mot de passe doit contenir au moins 8 caractères, une majuscule et un chiffre.",
        choisirPaysErreur: "Choisis ton pays.",
        entrerDateNaissance: "Entre ta date de naissance.",
        choisirSexeErreur: "Choisis ton sexe.",
        numeroInvalide: "Numéro invalide. Le {{pays}} nécessite exactement {{chiffres}} chiffres.",
        pseudoDejaUtilise: "Ce pseudo est déjà utilisé.",
        numeroDejaUtilise: "Ce numéro de téléphone est déjà utilisé.",
      ...
      admin: {
        ...
        pageReservee: "Cette page est réservée à l'administrateur.",
        chargement: "Chargement...",
        onglFeedbacks: "💬 Feedbacks",
        onglSignalements: "🚩 Signalements",
        onglRgpd: "🗑️ RGPD",
        aucunFeedback: "Aucun feedback pour l'instant.",
        aucunSignalement: "Aucun signalement pour l'instant.",
        contenuSignale: "Contenu signalé :",
        signalePar: "Signalé par {{pseudo}} — {{date}}",
        avertissementRgpd: "⚠️ Suppression complète et irréversible des données d'un utilisateur (droit à l'effacement RGPD).",
        emailPlaceholder: "Email de la personne",
        rechercher: "🔍 Rechercher",
        compteTrouve: "Compte trouvé :",
        resumeSuppression: "{{pub}} publications, {{com}} commentaires, {{msg}} messages seront supprimés définitivement.",
        confirmerEmail: "Tape l'email exact pour confirmer :",
        mdpAdminPlaceholder: "Ton mot de passe admin",
        supprimerDefinitivement: "🗑️ Supprimer définitivement",
        suppressionEnCours: "Suppression...",
        suppressionTerminee: "✅ Suppression terminée : {{pub}} publications, {{com}} commentaires, {{msg}} messages supprimés.",
        emailNeCorrespondPas: "L'email tapé ne correspond pas exactement.",
  ...
  en: {
    translation: {
      ...
      inscription: {
        ...
        pseudoObligatoire: "Username is required.",
        mdpTropFaible: "Password must contain at least 8 characters, one uppercase letter and one number.",
        choisirPaysErreur: "Choose your country.",
        entrerDateNaissance: "Enter your date of birth.",
        choisirSexeErreur: "Choose your gender.",
        numeroInvalide: "Invalid number. {{pays}} requires exactly {{chiffres}} digits.",
        pseudoDejaUtilise: "This username is already taken.",
        numeroDejaUtilise: "This phone number is already used.",
        emailDejaUtilise: "This email is already used by another account.",
        emailInvalide: "The email address is not valid.",
        mdpTropCourt: "Password must contain at least 6 characters.",
        erreurGenerale: "An error occurred. Try again.",
        suggestionsTitre: "Suggestions:",
      ...
      admin: {
        ...
        pageReservee: "This page is reserved for the administrator.",
        chargement: "Loading...",
        onglFeedbacks: "💬 Feedback",
        onglSignalements: "🚩 Reports",
        onglRgpd: "🗑️ RGPD",
        aucunFeedback: "No feedback yet.",
        aucunSignalement: "No reports yet.",
        contenuSignale: "Reported content:",
        signalePar: "Reported by {{pseudo}} — {{date}}",
        avertissementRgpd: "⚠️ Complete and irreversible deletion of a user's data (right to erasure).",
        emailPlaceholder: "Person's email",
        rechercher: "🔍 Search",
        compteTrouve: "Account found:",
        resumeSuppression: "{{pub}} posts, {{com}} comments, {{msg}} messages will be permanently deleted.",
        confirmerEmail: "Type the exact email to confirm:",
        mdpAdminPlaceholder: "Your admin password",
        supprimerDefinitivement: "🗑️ Delete permanently",
        suppressionEnCours: "Deleting...",
        suppressionTerminee: "✅ Deletion complete: {{pub}} posts, {{com}} comments, {{msg}} messages deleted.",
        emailNeCorrespondPas: "The typed email doesn't match exactly.",
